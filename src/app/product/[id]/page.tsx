...
import { useProduct, useProducts, Product } from "@/hooks/use-store-data";
...
const ProductPage = () => {
  ...
  const { data: productResponse, isLoading: productLoading, error: productError } = useProduct(params.id as string);
